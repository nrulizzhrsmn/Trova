...
Public Class CreditDebit
    ...
    Private Sub CreditDebit_Load(sender As Object, e As EventArgs) Handles Me.Load
        'to show the payment details
        lblAmount.Text = Format(price_booking, "currency")
        lblFrom_Account.Text = from_cardnumber
        lblTo_Account.Text = "Trova Enterprise - 7877675241"
    End Sub

    Private Sub CreditDebit_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        lblAmount.Text = ""
