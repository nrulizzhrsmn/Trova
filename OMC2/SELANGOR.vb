Public Class SELANGOR
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnBooking.Click
        Total_cost.state_travel = "SELANGOR"
        Total_cost.city_travel = "GOMBAK"
        Total_cost.poscode_travel = "68100"
        Total_cost.place_travel = "BATU CAVES"
        CurrentLocation.Show()
        Me.Hide()
    End Sub

    Private Sub pcbBooking2_Click(sender As Object, e As EventArgs) Handles pcbBooking2.Click
        Total_cost.state_travel = "SELANGOR"
        Total_cost.city_travel = "GOMBAK"
        Total_cost.poscode_travel = "68100"
        Total_cost.place_travel = "BATU CAVES"
