Public Class TERENGGANU
    Private Sub btnBook_Click(sender As Object, e As EventArgs) Handles btnBook.Click
        Total_cost.state_travel = "TERENGGANU"
        Total_cost.city_travel = "BESUT"
        Total_cost.poscode_travel = "22300"
        Total_cost.place_travel = "PULAU REDANG"
