Public Class MELAKA
    Private Sub btnBook_Click(sender As Object, e As EventArgs) Handles btnBook.Click
        Total_cost.state_travel = "MELAKA"
        Total_cost.city_travel = "TUN TAN CHENG LOCK"
        Total_cost.poscode_travel = "75200"
        Total_cost.place_travel = "BABA NYONYA HERITAGE MUSEUM"
